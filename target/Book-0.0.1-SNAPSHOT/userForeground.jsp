				...
				<table id="t" class="table ">
					<tr height="6%">
						<td align="center" colspan=2><br>
							...
							<div class="col-md-4 col-xs-12 col-md-offset-1 fm">
					...
					<tr align="center">
						<td>
									...
									<tr align='center'>
										...
										<td><c:choose>
												<c:when test="${empty qusername }">
						                         ...
						                         <!--  <a href="#" id="huanshu"
														class="btn  btn-sm  btn-default not"> 还书 </a> -->
												</c:when>
												<c:otherwise>
													<c:if test="${s.stock!=0}">
														<a
															href="<%=base%>UserForegroundServlet?action=jieshu&pageNew=${pb.pageNew+1 }&id=${s.id }&qusername=${qusername }&name=${s.name}"
							...
							</table> <c:if test="${showPesge=='soushuo'}">
								<p>第${pb.pageNew }页/共${pb.pages }&nbsp;&nbsp;&nbsp;&nbsp;
								<ul class="pagination ">

									<li><a href="${pb.url }&pageNew=1&qusername=${qusername }">首页</a>
										&nbsp;&nbsp;&nbsp;&nbsp;</li>
			               ...
			               1.页数小于10
							...
							</c:if> <c:if test="${showPesge=='xianshi'}">
								<p>第${pb.pageNew }页/共${pb.pages }&nbsp;&nbsp;&nbsp;&nbsp;
								<ul class="pagination ">
